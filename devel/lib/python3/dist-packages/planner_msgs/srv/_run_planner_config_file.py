...
"""autogenerated by genpy from planner_msgs/run_planner_config_fileRequest.msg. Do not edit."""
import codecs
import sys
...
class run_planner_config_fileRequest(genpy.Message):
  _md5sum = "3a5bef555858817b9c688ce8a2979c01"
  _type = "planner_msgs/run_planner_config_fileRequest"
...
"""
  __slots__ = ['path_configs_file','planner_type','run_id','flag_iter_or_time','iter_or_time','tree_optimization','informed_sampling','show_tree']
  _slot_types = ['string','string','uint8','uint8','float64','bool','bool','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       path_configs_file,planner_type,run_id,flag_iter_or_time,iter_or_time,tree_optimization,informed_sampling,show_tree
    ...
    """
    if args or kwds:
      super(run_planner_config_fileRequest, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.path_configs_file is None:
        self.path_configs_file = ''
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.path_configs_file = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.path_configs_file = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from planner_msgs/run_planner_config_fileResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class run_planner_config_fileResponse(genpy.Message):
  _md5sum = "cb34f92ebddcd3e658fb29e6f20a0171"
  _type = "planner_msgs/run_planner_config_fileResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """
...
float64[] array1d_double"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(run_planner_config_fileResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_B():
    ...
    return _struct_B
class run_planner_config_file(object):
  _type          = 'planner_msgs/run_planner_config_file'
  _md5sum = '0e458c66c66f2aaa7786720f9a33b65b'
  _request_class  = run_planner_config_fileRequest
  _response_class = run_planner_config_fileResponse
