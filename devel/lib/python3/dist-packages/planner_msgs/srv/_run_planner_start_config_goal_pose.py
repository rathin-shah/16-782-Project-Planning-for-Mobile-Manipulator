...
"""autogenerated by genpy from planner_msgs/run_planner_start_config_goal_poseRequest.msg. Do not edit."""
import codecs
import sys
...
class run_planner_start_config_goal_poseRequest(genpy.Message):
  _md5sum = "6c80be67d948a787e54626f8f4a12ac0"
  _type = "planner_msgs/run_planner_start_config_goal_poseRequest"
...
float64[] array1d_double"""
  __slots__ = ['start_config','goal_ee_pose','constraint_vec_goal_pose','target_coordinate_dev','planner_type','run_id','flag_iter_or_time','iter_or_time','tree_optimization','informed_sampling','show_tree']
  _slot_types = ['float64[]','float64[]','int32[]','planner_msgs/array2d_double','string','uint8','uint8','float64','bool','bool','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       start_config,goal_ee_pose,constraint_vec_goal_pose,target_coordinate_dev,planner_type,run_id,flag_iter_or_time,iter_or_time,tree_optimization,informed_sampling,show_tree
    ...
    """
    if args or kwds:
      super(run_planner_start_config_goal_poseRequest, self).__init__(*args, **kwds)
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from planner_msgs/run_planner_start_config_goal_poseResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class run_planner_start_config_goal_poseResponse(genpy.Message):
  _md5sum = "cb34f92ebddcd3e658fb29e6f20a0171"
  _type = "planner_msgs/run_planner_start_config_goal_poseResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """
...
float64[] array1d_double"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(run_planner_start_config_goal_poseResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_B():
    ...
    return _struct_B
class run_planner_start_config_goal_pose(object):
  _type          = 'planner_msgs/run_planner_start_config_goal_pose'
  _md5sum = '52f99dbdc36e47c1a5a17d5c3942553e'
  _request_class  = run_planner_start_config_goal_poseRequest
  _response_class = run_planner_start_config_goal_poseResponse
