...
"""autogenerated by genpy from planner_msgs/run_planner_map_goal_configRequest.msg. Do not edit."""
import codecs
import sys
...
class run_planner_map_goal_configRequest(genpy.Message):
  _md5sum = "ea3d1b77d92e86d4604b51593c2d2c88"
  _type = "planner_msgs/run_planner_map_goal_configRequest"
...
"""
  __slots__ = ['goal_config','planner_type','run_id','flag_iter_or_time','iter_or_time','tree_optimization','informed_sampling','show_tree']
  _slot_types = ['float64[]','string','uint8','uint8','float64','bool','bool','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       goal_config,planner_type,run_id,flag_iter_or_time,iter_or_time,tree_optimization,informed_sampling,show_tree
    ...
    """
    if args or kwds:
      super(run_planner_map_goal_configRequest, self).__init__(*args, **kwds)
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from planner_msgs/run_planner_map_goal_configResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class run_planner_map_goal_configResponse(genpy.Message):
  _md5sum = "cb34f92ebddcd3e658fb29e6f20a0171"
  _type = "planner_msgs/run_planner_map_goal_configResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """
...
float64[] array1d_double"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(run_planner_map_goal_configResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_B():
    ...
    return _struct_B
class run_planner_map_goal_config(object):
  _type          = 'planner_msgs/run_planner_map_goal_config'
  _md5sum = '286271ef712febf633313deb7274b04b'
  _request_class  = run_planner_map_goal_configRequest
  _response_class = run_planner_map_goal_configResponse
