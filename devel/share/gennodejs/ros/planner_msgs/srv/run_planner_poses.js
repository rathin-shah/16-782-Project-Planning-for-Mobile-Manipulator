...
class run_planner_posesRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type run_planner_posesRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type run_planner_posesRequest
    let len;
    let data = new run_planner_posesRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new run_planner_posesRequest(null);
...
class run_planner_posesResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type run_planner_posesResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type run_planner_posesResponse
    let len;
    let data = new run_planner_posesResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'planner_msgs/run_planner_posesResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new run_planner_posesResponse(null);
...
module.exports = {
  Request: run_planner_posesRequest,
  Response: run_planner_posesResponse,
  md5sum() { return 'a6cba430226c7744dd14ae64a4634010'; },
  datatype() { return 'planner_msgs/run_planner_poses'; }
};
