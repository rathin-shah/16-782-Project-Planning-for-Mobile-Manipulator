...
class run_planner_config_fileRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.path_configs_file = null;
      ...
      if (initObj.hasOwnProperty('path_configs_file')) {
        this.path_configs_file = initObj.path_configs_file
      }
      else {
        this.path_configs_file = '';
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type run_planner_config_fileRequest
    // Serialize message field [path_configs_file]
    bufferOffset = _serializer.string(obj.path_configs_file, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type run_planner_config_fileRequest
    let len;
    let data = new run_planner_config_fileRequest(null);
    // Deserialize message field [path_configs_file]
    data.path_configs_file = _deserializer.string(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    let length = 0;
    length += _getByteLength(object.path_configs_file);
  ...
  static Resolve(msg) {
    ...
    const resolved = new run_planner_config_fileRequest(null);
    if (msg.path_configs_file !== undefined) {
      resolved.path_configs_file = msg.path_configs_file;
    }
    else {
      resolved.path_configs_file = ''
    }
...
class run_planner_config_fileResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type run_planner_config_fileResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type run_planner_config_fileResponse
    let len;
    let data = new run_planner_config_fileResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'planner_msgs/run_planner_config_fileResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new run_planner_config_fileResponse(null);
...
module.exports = {
  Request: run_planner_config_fileRequest,
  Response: run_planner_config_fileResponse,
  md5sum() { return '0e458c66c66f2aaa7786720f9a33b65b'; },
  datatype() { return 'planner_msgs/run_planner_config_file'; }
};
