...
class run_planner_configsRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type run_planner_configsRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type run_planner_configsRequest
    let len;
    let data = new run_planner_configsRequest(null);
  ...
  static datatype() {
    ...
    return 'planner_msgs/run_planner_configsRequest';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '4c8b4d90bdad3d1800e49256a22af5b7';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new run_planner_configsRequest(null);
...
class run_planner_configsResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type run_planner_configsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type run_planner_configsResponse
    let len;
    let data = new run_planner_configsResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'planner_msgs/run_planner_configsResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new run_planner_configsResponse(null);
...
module.exports = {
  Request: run_planner_configsRequest,
  Response: run_planner_configsResponse,
  md5sum() { return '8ca5afb164ebfb318e4cc0e72e99b251'; },
  datatype() { return 'planner_msgs/run_planner_configs'; }
};
