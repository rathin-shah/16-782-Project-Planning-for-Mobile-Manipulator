...
class run_planner_start_config_goal_poseRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.start_config = null;
      ...
      if (initObj.hasOwnProperty('start_config')) {
        this.start_config = initObj.start_config
      }
      else {
        this.start_config = [];
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type run_planner_start_config_goal_poseRequest
    // Serialize message field [start_config]
    bufferOffset = _arraySerializer.float64(obj.start_config, buffer, bufferOffset, null);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type run_planner_start_config_goal_poseRequest
    let len;
    let data = new run_planner_start_config_goal_poseRequest(null);
    // Deserialize message field [start_config]
    data.start_config = _arrayDeserializer.float64(buffer, bufferOffset, null)
  ...
  static getMessageSize(object) {
    let length = 0;
    length += 8 * object.start_config.length;
  ...
  static Resolve(msg) {
    ...
    const resolved = new run_planner_start_config_goal_poseRequest(null);
    if (msg.start_config !== undefined) {
      resolved.start_config = msg.start_config;
    }
    else {
      resolved.start_config = []
    }
...
class run_planner_start_config_goal_poseResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type run_planner_start_config_goal_poseResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type run_planner_start_config_goal_poseResponse
    let len;
    let data = new run_planner_start_config_goal_poseResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'planner_msgs/run_planner_start_config_goal_poseResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new run_planner_start_config_goal_poseResponse(null);
...
module.exports = {
  Request: run_planner_start_config_goal_poseRequest,
  Response: run_planner_start_config_goal_poseResponse,
  md5sum() { return '52f99dbdc36e47c1a5a17d5c3942553e'; },
  datatype() { return 'planner_msgs/run_planner_start_config_goal_pose'; }
};
