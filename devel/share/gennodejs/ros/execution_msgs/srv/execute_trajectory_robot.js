...
class execute_trajectory_robotRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type execute_trajectory_robotRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type execute_trajectory_robotRequest
    let len;
    let data = new execute_trajectory_robotRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new execute_trajectory_robotRequest(null);
...
class execute_trajectory_robotResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type execute_trajectory_robotResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type execute_trajectory_robotResponse
    let len;
    let data = new execute_trajectory_robotResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'execution_msgs/execute_trajectory_robotResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new execute_trajectory_robotResponse(null);
...
module.exports = {
  Request: execute_trajectory_robotRequest,
  Response: execute_trajectory_robotResponse,
  md5sum() { return '05acbdefe3087529e04386c5ff659953'; },
  datatype() { return 'execution_msgs/execute_trajectory_robot'; }
};
