...
;//! \htmlinclude run_planner_start_config_goal_pose-request.msg.html

(cl:defclass <run_planner_start_config_goal_pose-request> (roslisp-msg-protocol:ros-message)
  ((start_config
    :reader start_config
...
(cl:defclass run_planner_start_config_goal_pose-request (<run_planner_start_config_goal_pose-request>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <run_planner_start_config_goal_pose-request>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'run_planner_start_config_goal_pose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planner_msgs-srv:<run_planner_start_config_goal_pose-request> is deprecated: use planner_msgs-srv:run_planner_start_config_goal_pose-request instead.")))

(cl:ensure-generic-function 'start_config-val :lambda-list '(m))
(cl:defmethod start_config-val ((m <run_planner_start_config_goal_pose-request>))
...
(cl:defmethod goal_ee_pose-val ((m <run_planner_start_config_goal_pose-request>))
...
(cl:defmethod constraint_vec_goal_pose-val ((m <run_planner_start_config_goal_pose-request>))
...
(cl:defmethod target_coordinate_dev-val ((m <run_planner_start_config_goal_pose-request>))
...
(cl:defmethod planner_type-val ((m <run_planner_start_config_goal_pose-request>))
...
(cl:defmethod run_id-val ((m <run_planner_start_config_goal_pose-request>))
...
(cl:defmethod flag_iter_or_time-val ((m <run_planner_start_config_goal_pose-request>))
...
(cl:defmethod iter_or_time-val ((m <run_planner_start_config_goal_pose-request>))
...
(cl:defmethod tree_optimization-val ((m <run_planner_start_config_goal_pose-request>))
...
(cl:defmethod informed_sampling-val ((m <run_planner_start_config_goal_pose-request>))
...
(cl:defmethod show_tree-val ((m <run_planner_start_config_goal_pose-request>))
  ...
  (show_tree m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <run_planner_start_config_goal_pose-request>) ostream)
  "Serializes a message object of type '<run_planner_start_config_goal_pose-request>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <run_planner_start_config_goal_pose-request>) istream)
  "Deserializes a message object of type '<run_planner_start_config_goal_pose-request>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<run_planner_start_config_goal_pose-request>)))
  "Returns string type for a service object of type '<run_planner_start_config_goal_pose-request>"
  "planner_msgs/run_planner_start_config_goal_poseRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'run_planner_start_config_goal_pose-request)))
  "Returns string type for a service object of type 'run_planner_start_config_goal_pose-request"
  "planner_msgs/run_planner_start_config_goal_poseRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<run_planner_start_config_goal_pose-request>)))
  "Returns md5sum for a message object of type '<run_planner_start_config_goal_pose-request>"
  "52f99dbdc36e47c1a5a17d5c3942553e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'run_planner_start_config_goal_pose-request)))
  "Returns md5sum for a message object of type 'run_planner_start_config_goal_pose-request"
  "52f99dbdc36e47c1a5a17d5c3942553e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<run_planner_start_config_goal_pose-request>)))
  "Returns full string definition for message of type '<run_planner_start_config_goal_pose-request>"
  (cl:format cl:nil "~%#Start and Goal Config~%float64[] start_config~%~%#Goal EE pose~%float64[] goal_ee_pose~%int32[] constraint_vec_goal_pose~%~%#Permitted displacement of EE w.r.t target frame~%array2d_double target_coordinate_dev~%~%#Type of planner (uni or bidirectional)~%string planner_type~%~%#ID of the planner run~%uint8 run_id~%~%#Flag indicating whether maximum number of iterations of runtime is used~%uint8 flag_iter_or_time~%~%#Max. number of iterations / or max. runtime ~%float64 iter_or_time~%~%#Flag indicating whether tree optimization is used~%bool tree_optimization~%~%#Flag indicating whether informed sampling is used~%bool informed_sampling~%~%#Flag to visualize planning process~%bool show_tree~%~%~%================================================================================~%MSG: planner_msgs/array2d_double~%array1d_double[] array2d_double~%================================================================================~%MSG: planner_msgs/array1d_double~%float64[] array1d_double~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'run_planner_start_config_goal_pose-request)))
  "Returns full string definition for message of type 'run_planner_start_config_goal_pose-request"
  (cl:format cl:nil "~%#Start and Goal Config~%float64[] start_config~%~%#Goal EE pose~%float64[] goal_ee_pose~%int32[] constraint_vec_goal_pose~%~%#Permitted displacement of EE w.r.t target frame~%array2d_double target_coordinate_dev~%~%#Type of planner (uni or bidirectional)~%string planner_type~%~%#ID of the planner run~%uint8 run_id~%~%#Flag indicating whether maximum number of iterations of runtime is used~%uint8 flag_iter_or_time~%~%#Max. number of iterations / or max. runtime ~%float64 iter_or_time~%~%#Flag indicating whether tree optimization is used~%bool tree_optimization~%~%#Flag indicating whether informed sampling is used~%bool informed_sampling~%~%#Flag to visualize planning process~%bool show_tree~%~%~%================================================================================~%MSG: planner_msgs/array2d_double~%array1d_double[] array2d_double~%================================================================================~%MSG: planner_msgs/array1d_double~%float64[] array1d_double~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <run_planner_start_config_goal_pose-request>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <run_planner_start_config_goal_pose-request>))
  "Converts a ROS message object to a list"
  (cl:list 'run_planner_start_config_goal_pose-request
...
;//! \htmlinclude run_planner_start_config_goal_pose-response.msg.html

(cl:defclass <run_planner_start_config_goal_pose-response> (roslisp-msg-protocol:ros-message)
  ((joint_trajectory
...
(cl:defclass run_planner_start_config_goal_pose-response (<run_planner_start_config_goal_pose-response>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <run_planner_start_config_goal_pose-response>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'run_planner_start_config_goal_pose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planner_msgs-srv:<run_planner_start_config_goal_pose-response> is deprecated: use planner_msgs-srv:run_planner_start_config_goal_pose-response instead.")))

(cl:ensure-generic-function 'joint_trajectory-val :lambda-list '(m))
(cl:defmethod joint_trajectory-val ((m <run_planner_start_config_goal_pose-response>))
...
(cl:defmethod ee_trajectory-val ((m <run_planner_start_config_goal_pose-response>))
...
(cl:defmethod success-val ((m <run_planner_start_config_goal_pose-response>))
  ...
  (success m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <run_planner_start_config_goal_pose-response>) ostream)
  "Serializes a message object of type '<run_planner_start_config_goal_pose-response>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <run_planner_start_config_goal_pose-response>) istream)
  "Deserializes a message object of type '<run_planner_start_config_goal_pose-response>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<run_planner_start_config_goal_pose-response>)))
  "Returns string type for a service object of type '<run_planner_start_config_goal_pose-response>"
  "planner_msgs/run_planner_start_config_goal_poseResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'run_planner_start_config_goal_pose-response)))
  "Returns string type for a service object of type 'run_planner_start_config_goal_pose-response"
  "planner_msgs/run_planner_start_config_goal_poseResponse")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<run_planner_start_config_goal_pose-response>)))
  "Returns md5sum for a message object of type '<run_planner_start_config_goal_pose-response>"
  "52f99dbdc36e47c1a5a17d5c3942553e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'run_planner_start_config_goal_pose-response)))
  "Returns md5sum for a message object of type 'run_planner_start_config_goal_pose-response"
  "52f99dbdc36e47c1a5a17d5c3942553e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<run_planner_start_config_goal_pose-response>)))
  "Returns full string definition for message of type '<run_planner_start_config_goal_pose-response>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'run_planner_start_config_goal_pose-response)))
  "Returns full string definition for message of type 'run_planner_start_config_goal_pose-response"
  (cl:format cl:nil "~%#Planned joint trajectory~%array2d_double joint_trajectory~%~%#Planned endeffector trajectory~%array2d_double ee_trajectory~%~%#Planning result~%bool success~%~%~%~%================================================================================~%MSG: planner_msgs/array2d_double~%array1d_double[] array2d_double~%================================================================================~%MSG: planner_msgs/array1d_double~%float64[] array1d_double~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <run_planner_start_config_goal_pose-response>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <run_planner_start_config_goal_pose-response>))
  "Converts a ROS message object to a list"
  (cl:list 'run_planner_start_config_goal_pose-response
    (cl:cons ':joint_trajectory (joint_trajectory msg))
    (cl:cons ':ee_trajectory (ee_trajectory msg))
    (cl:cons ':success (success msg))
))
(cl:defmethod roslisp-msg-protocol:service-request-type ((msg (cl:eql 'run_planner_start_config_goal_pose)))
  'run_planner_start_config_goal_pose-request)
(cl:defmethod roslisp-msg-protocol:service-response-type ((msg (cl:eql 'run_planner_start_config_goal_pose)))
  'run_planner_start_config_goal_pose-response)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'run_planner_start_config_goal_pose)))
  "Returns string type for a service object of type '<run_planner_start_config_goal_pose>"
  "planner_msgs/run_planner_start_config_goal_pose")