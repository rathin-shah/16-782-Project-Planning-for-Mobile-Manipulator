...
;//! \htmlinclude run_planner_poses-request.msg.html

(cl:defclass <run_planner_poses-request> (roslisp-msg-protocol:ros-message)
  ((start_ee_pose
...
(cl:defclass run_planner_poses-request (<run_planner_poses-request>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <run_planner_poses-request>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'run_planner_poses-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planner_msgs-srv:<run_planner_poses-request> is deprecated: use planner_msgs-srv:run_planner_poses-request instead.")))

(cl:ensure-generic-function 'start_ee_pose-val :lambda-list '(m))
(cl:defmethod start_ee_pose-val ((m <run_planner_poses-request>))
...
(cl:defmethod constraint_vec_start_pose-val ((m <run_planner_poses-request>))
...
(cl:defmethod goal_ee_pose-val ((m <run_planner_poses-request>))
...
(cl:defmethod constraint_vec_goal_pose-val ((m <run_planner_poses-request>))
...
(cl:defmethod target_coordinate_dev-val ((m <run_planner_poses-request>))
...
(cl:defmethod planner_type-val ((m <run_planner_poses-request>))
...
(cl:defmethod run_id-val ((m <run_planner_poses-request>))
...
(cl:defmethod flag_iter_or_time-val ((m <run_planner_poses-request>))
...
(cl:defmethod iter_or_time-val ((m <run_planner_poses-request>))
...
(cl:defmethod tree_optimization-val ((m <run_planner_poses-request>))
...
(cl:defmethod informed_sampling-val ((m <run_planner_poses-request>))
...
(cl:defmethod show_tree-val ((m <run_planner_poses-request>))
  ...
  (show_tree m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <run_planner_poses-request>) ostream)
  "Serializes a message object of type '<run_planner_poses-request>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <run_planner_poses-request>) istream)
  "Deserializes a message object of type '<run_planner_poses-request>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<run_planner_poses-request>)))
  "Returns string type for a service object of type '<run_planner_poses-request>"
  "planner_msgs/run_planner_posesRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'run_planner_poses-request)))
  "Returns string type for a service object of type 'run_planner_poses-request"
  "planner_msgs/run_planner_posesRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<run_planner_poses-request>)))
  "Returns md5sum for a message object of type '<run_planner_poses-request>"
  "a6cba430226c7744dd14ae64a4634010")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'run_planner_poses-request)))
  "Returns md5sum for a message object of type 'run_planner_poses-request"
  "a6cba430226c7744dd14ae64a4634010")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<run_planner_poses-request>)))
  "Returns full string definition for message of type '<run_planner_poses-request>"
  (cl:format cl:nil "~%#Start EE pose~%float64[] start_ee_pose~%int32[] constraint_vec_start_pose~%~%#Goal EE pose~%float64[] goal_ee_pose~%int32[] constraint_vec_goal_pose~%~%#Permitted displacement of EE w.r.t target frame~%array2d_double target_coordinate_dev~%~%#Type of planner (uni or bidirectional)~%string planner_type~%~%#ID of the planner run~%uint8 run_id~%~%#Flag indicating whether maximum number of iterations of runtime is used~%uint8 flag_iter_or_time~%~%#Max. number of iterations / or max. runtime ~%float64 iter_or_time~%~%#Flag indicating whether tree optimization is used~%bool tree_optimization~%~%#Flag indicating whether informed sampling is used~%bool informed_sampling~%~%#Flag to visualize planning process~%bool show_tree~%~%~%================================================================================~%MSG: planner_msgs/array2d_double~%array1d_double[] array2d_double~%================================================================================~%MSG: planner_msgs/array1d_double~%float64[] array1d_double~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'run_planner_poses-request)))
  "Returns full string definition for message of type 'run_planner_poses-request"
  (cl:format cl:nil "~%#Start EE pose~%float64[] start_ee_pose~%int32[] constraint_vec_start_pose~%~%#Goal EE pose~%float64[] goal_ee_pose~%int32[] constraint_vec_goal_pose~%~%#Permitted displacement of EE w.r.t target frame~%array2d_double target_coordinate_dev~%~%#Type of planner (uni or bidirectional)~%string planner_type~%~%#ID of the planner run~%uint8 run_id~%~%#Flag indicating whether maximum number of iterations of runtime is used~%uint8 flag_iter_or_time~%~%#Max. number of iterations / or max. runtime ~%float64 iter_or_time~%~%#Flag indicating whether tree optimization is used~%bool tree_optimization~%~%#Flag indicating whether informed sampling is used~%bool informed_sampling~%~%#Flag to visualize planning process~%bool show_tree~%~%~%================================================================================~%MSG: planner_msgs/array2d_double~%array1d_double[] array2d_double~%================================================================================~%MSG: planner_msgs/array1d_double~%float64[] array1d_double~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <run_planner_poses-request>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <run_planner_poses-request>))
  "Converts a ROS message object to a list"
  (cl:list 'run_planner_poses-request
...
;//! \htmlinclude run_planner_poses-response.msg.html

(cl:defclass <run_planner_poses-response> (roslisp-msg-protocol:ros-message)
  ((joint_trajectory
...
(cl:defclass run_planner_poses-response (<run_planner_poses-response>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <run_planner_poses-response>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'run_planner_poses-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planner_msgs-srv:<run_planner_poses-response> is deprecated: use planner_msgs-srv:run_planner_poses-response instead.")))

(cl:ensure-generic-function 'joint_trajectory-val :lambda-list '(m))
(cl:defmethod joint_trajectory-val ((m <run_planner_poses-response>))
...
(cl:defmethod ee_trajectory-val ((m <run_planner_poses-response>))
...
(cl:defmethod success-val ((m <run_planner_poses-response>))
  ...
  (success m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <run_planner_poses-response>) ostream)
  "Serializes a message object of type '<run_planner_poses-response>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <run_planner_poses-response>) istream)
  "Deserializes a message object of type '<run_planner_poses-response>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<run_planner_poses-response>)))
  "Returns string type for a service object of type '<run_planner_poses-response>"
  "planner_msgs/run_planner_posesResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'run_planner_poses-response)))
  "Returns string type for a service object of type 'run_planner_poses-response"
  "planner_msgs/run_planner_posesResponse")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<run_planner_poses-response>)))
  "Returns md5sum for a message object of type '<run_planner_poses-response>"
  "a6cba430226c7744dd14ae64a4634010")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'run_planner_poses-response)))
  "Returns md5sum for a message object of type 'run_planner_poses-response"
  "a6cba430226c7744dd14ae64a4634010")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<run_planner_poses-response>)))
  "Returns full string definition for message of type '<run_planner_poses-response>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'run_planner_poses-response)))
  "Returns full string definition for message of type 'run_planner_poses-response"
  (cl:format cl:nil "~%#Planned joint trajectory~%array2d_double joint_trajectory~%~%#Planned endeffector trajectory~%array2d_double ee_trajectory~%~%#Planning result~%bool success~%~%~%~%================================================================================~%MSG: planner_msgs/array2d_double~%array1d_double[] array2d_double~%================================================================================~%MSG: planner_msgs/array1d_double~%float64[] array1d_double~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <run_planner_poses-response>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <run_planner_poses-response>))
  "Converts a ROS message object to a list"
  (cl:list 'run_planner_poses-response
    (cl:cons ':joint_trajectory (joint_trajectory msg))
    (cl:cons ':ee_trajectory (ee_trajectory msg))
    (cl:cons ':success (success msg))
))
(cl:defmethod roslisp-msg-protocol:service-request-type ((msg (cl:eql 'run_planner_poses)))
  'run_planner_poses-request)
(cl:defmethod roslisp-msg-protocol:service-response-type ((msg (cl:eql 'run_planner_poses)))
  'run_planner_poses-response)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'run_planner_poses)))
  "Returns string type for a service object of type '<run_planner_poses>"
  "planner_msgs/run_planner_poses")