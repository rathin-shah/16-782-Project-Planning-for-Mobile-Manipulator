...
;//! \htmlinclude run_planner_map_goal_config-request.msg.html

(cl:defclass <run_planner_map_goal_config-request> (roslisp-msg-protocol:ros-message)
  ((goal_config
    :reader goal_config
    :initarg :goal_config
...
(cl:defclass run_planner_map_goal_config-request (<run_planner_map_goal_config-request>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <run_planner_map_goal_config-request>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'run_planner_map_goal_config-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planner_msgs-srv:<run_planner_map_goal_config-request> is deprecated: use planner_msgs-srv:run_planner_map_goal_config-request instead.")))

(cl:ensure-generic-function 'goal_config-val :lambda-list '(m))
(cl:defmethod goal_config-val ((m <run_planner_map_goal_config-request>))
...
(cl:defmethod planner_type-val ((m <run_planner_map_goal_config-request>))
...
(cl:defmethod run_id-val ((m <run_planner_map_goal_config-request>))
...
(cl:defmethod flag_iter_or_time-val ((m <run_planner_map_goal_config-request>))
...
(cl:defmethod iter_or_time-val ((m <run_planner_map_goal_config-request>))
...
(cl:defmethod tree_optimization-val ((m <run_planner_map_goal_config-request>))
...
(cl:defmethod informed_sampling-val ((m <run_planner_map_goal_config-request>))
...
(cl:defmethod show_tree-val ((m <run_planner_map_goal_config-request>))
  ...
  (show_tree m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <run_planner_map_goal_config-request>) ostream)
  "Serializes a message object of type '<run_planner_map_goal_config-request>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <run_planner_map_goal_config-request>) istream)
  "Deserializes a message object of type '<run_planner_map_goal_config-request>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<run_planner_map_goal_config-request>)))
  "Returns string type for a service object of type '<run_planner_map_goal_config-request>"
  "planner_msgs/run_planner_map_goal_configRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'run_planner_map_goal_config-request)))
  "Returns string type for a service object of type 'run_planner_map_goal_config-request"
  "planner_msgs/run_planner_map_goal_configRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<run_planner_map_goal_config-request>)))
  "Returns md5sum for a message object of type '<run_planner_map_goal_config-request>"
  "286271ef712febf633313deb7274b04b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'run_planner_map_goal_config-request)))
  "Returns md5sum for a message object of type 'run_planner_map_goal_config-request"
  "286271ef712febf633313deb7274b04b")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<run_planner_map_goal_config-request>)))
  "Returns full string definition for message of type '<run_planner_map_goal_config-request>"
  (cl:format cl:nil "~%#Start and Goal Config~%float64[] goal_config~%~%#Type of planner (uni or bidirectional)~%string planner_type~%~%#ID of the planner run~%uint8 run_id~%~%#Flag indicating whether maximum number of iterations of runtime is used~%uint8 flag_iter_or_time~%~%#Max. number of iterations / or max. runtime ~%float64 iter_or_time~%~%#Flag indicating whether tree optimization is used~%bool tree_optimization~%~%#Flag indicating whether informed sampling is used~%bool informed_sampling~%~%#Flag to visualize planning process~%bool show_tree~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'run_planner_map_goal_config-request)))
  "Returns full string definition for message of type 'run_planner_map_goal_config-request"
  (cl:format cl:nil "~%#Start and Goal Config~%float64[] goal_config~%~%#Type of planner (uni or bidirectional)~%string planner_type~%~%#ID of the planner run~%uint8 run_id~%~%#Flag indicating whether maximum number of iterations of runtime is used~%uint8 flag_iter_or_time~%~%#Max. number of iterations / or max. runtime ~%float64 iter_or_time~%~%#Flag indicating whether tree optimization is used~%bool tree_optimization~%~%#Flag indicating whether informed sampling is used~%bool informed_sampling~%~%#Flag to visualize planning process~%bool show_tree~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <run_planner_map_goal_config-request>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <run_planner_map_goal_config-request>))
  "Converts a ROS message object to a list"
  (cl:list 'run_planner_map_goal_config-request
...
;//! \htmlinclude run_planner_map_goal_config-response.msg.html

(cl:defclass <run_planner_map_goal_config-response> (roslisp-msg-protocol:ros-message)
  ((joint_trajectory
...
(cl:defclass run_planner_map_goal_config-response (<run_planner_map_goal_config-response>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <run_planner_map_goal_config-response>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'run_planner_map_goal_config-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planner_msgs-srv:<run_planner_map_goal_config-response> is deprecated: use planner_msgs-srv:run_planner_map_goal_config-response instead.")))

(cl:ensure-generic-function 'joint_trajectory-val :lambda-list '(m))
(cl:defmethod joint_trajectory-val ((m <run_planner_map_goal_config-response>))
...
(cl:defmethod ee_trajectory-val ((m <run_planner_map_goal_config-response>))
...
(cl:defmethod success-val ((m <run_planner_map_goal_config-response>))
  ...
  (success m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <run_planner_map_goal_config-response>) ostream)
  "Serializes a message object of type '<run_planner_map_goal_config-response>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <run_planner_map_goal_config-response>) istream)
  "Deserializes a message object of type '<run_planner_map_goal_config-response>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<run_planner_map_goal_config-response>)))
  "Returns string type for a service object of type '<run_planner_map_goal_config-response>"
  "planner_msgs/run_planner_map_goal_configResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'run_planner_map_goal_config-response)))
  "Returns string type for a service object of type 'run_planner_map_goal_config-response"
  "planner_msgs/run_planner_map_goal_configResponse")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<run_planner_map_goal_config-response>)))
  "Returns md5sum for a message object of type '<run_planner_map_goal_config-response>"
  "286271ef712febf633313deb7274b04b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'run_planner_map_goal_config-response)))
  "Returns md5sum for a message object of type 'run_planner_map_goal_config-response"
  "286271ef712febf633313deb7274b04b")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<run_planner_map_goal_config-response>)))
  "Returns full string definition for message of type '<run_planner_map_goal_config-response>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'run_planner_map_goal_config-response)))
  "Returns full string definition for message of type 'run_planner_map_goal_config-response"
  (cl:format cl:nil "~%#Planned joint trajectory~%array2d_double joint_trajectory~%~%#Planned endeffector trajectory~%array2d_double ee_trajectory~%~%#Planning result~%bool success~%~%================================================================================~%MSG: planner_msgs/array2d_double~%array1d_double[] array2d_double~%================================================================================~%MSG: planner_msgs/array1d_double~%float64[] array1d_double~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <run_planner_map_goal_config-response>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <run_planner_map_goal_config-response>))
  "Converts a ROS message object to a list"
  (cl:list 'run_planner_map_goal_config-response
    (cl:cons ':joint_trajectory (joint_trajectory msg))
    (cl:cons ':ee_trajectory (ee_trajectory msg))
    (cl:cons ':success (success msg))
))
(cl:defmethod roslisp-msg-protocol:service-request-type ((msg (cl:eql 'run_planner_map_goal_config)))
  'run_planner_map_goal_config-request)
(cl:defmethod roslisp-msg-protocol:service-response-type ((msg (cl:eql 'run_planner_map_goal_config)))
  'run_planner_map_goal_config-response)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'run_planner_map_goal_config)))
  "Returns string type for a service object of type '<run_planner_map_goal_config>"
  "planner_msgs/run_planner_map_goal_config")