// Generated by gencpp from file planner_msgs/run_planner_configsRequest.msg
// DO NOT EDIT!


#ifndef PLANNER_MSGS_MESSAGE_RUN_PLANNER_CONFIGSREQUEST_H
#define PLANNER_MSGS_MESSAGE_RUN_PLANNER_CONFIGSREQUEST_H
...
struct run_planner_configsRequest_
{
  typedef run_planner_configsRequest_<ContainerAllocator> Type;

  run_planner_configsRequest_()
    : start_config()
    , goal_config()
    , planner_type()
    , run_id(0)
  ...
  run_planner_configsRequest_(const ContainerAllocator& _alloc)
    : start_config(_alloc)
    , goal_config(_alloc)
    , planner_type(_alloc)
    , run_id(0)
  ...
  typedef boost::shared_ptr< ::planner_msgs::run_planner_configsRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::planner_msgs::run_planner_configsRequest_<ContainerAllocator> const> ConstPtr;

}; // struct run_planner_configsRequest_

typedef ::planner_msgs::run_planner_configsRequest_<std::allocator<void> > run_planner_configsRequest;

typedef boost::shared_ptr< ::planner_msgs::run_planner_configsRequest > run_planner_configsRequestPtr;
typedef boost::shared_ptr< ::planner_msgs::run_planner_configsRequest const> run_planner_configsRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::planner_msgs::run_planner_configsRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::planner_msgs::run_planner_configsRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::planner_msgs::run_planner_configsRequest_<ContainerAllocator1> & lhs, const ::planner_msgs::run_planner_configsRequest_<ContainerAllocator2> & rhs)
{
  return lhs.start_config == rhs.start_config &&
    lhs.goal_config == rhs.goal_config &&
...
template <class ContainerAllocator>
struct IsMessage< ::planner_msgs::run_planner_configsRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::planner_msgs::run_planner_configsRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::planner_msgs::run_planner_configsRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::planner_msgs::run_planner_configsRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::planner_msgs::run_planner_configsRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::planner_msgs::run_planner_configsRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::planner_msgs::run_planner_configsRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::planner_msgs::run_planner_configsRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4c8b4d90bdad3d18ULL;
  static const uint64_t static_value2 = 0x00e49256a22af5b7ULL;
};

template<class ContainerAllocator>
struct DataType< ::planner_msgs::run_planner_configsRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::planner_msgs::run_planner_configsRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::planner_msgs::run_planner_configsRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::planner_msgs::run_planner_configsRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::planner_msgs::run_planner_configsRequest_<ContainerAllocator>& v)
  {
...
#endif // PLANNER_MSGS_MESSAGE_RUN_PLANNER_CONFIGSREQUEST_H
